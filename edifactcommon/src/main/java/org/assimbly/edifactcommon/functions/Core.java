...
import org.assimbly.edifactcommon.UserException;
import org.assimbly.edifactcommon.mapforce.*;
import org.assimbly.edifactcommon.types.DateTime;
import org.assimbly.edifactcommon.types.Duration;
...
public class Core
{
	...
	{
		if (source.getNodeKind() == IMFNode.MFNodeKind_Attribute || source.getNodeKind() == IMFNode.MFNodeKind_Field)
			return new MFAttribute(source.getLocalName(), source.getNamespaceURI(), source.getPrefix(), content);
		return new MFElement(source.getLocalName(), source.getNamespaceURI(), source.getPrefix(), content);
	}
	...
	public static IMFNode resultDocument(String filename, String encoding, IEnumerable content)
	{
	...
	// nodeName
	public static javax.xml.namespace.QName nodeName(IMFNode n)
	{
	...
	public static IEnumerable tokenize(String input, String delimiter)
	{
		...
		return new MFElement.ArrayListAsEnumerable(tokens);
	}
	...
	{
		throw new UserException(content);
	}

	public static IMFNode createElement(javax.xml.namespace.QName qname, IEnumerable content)
	{
		return new MFElement(qname, content);
	}

	public static IMFNode createElement(String name, IEnumerable content)
	{
		return new MFElement(name, content);
	}
	
	public static IMFNode createAttribute(javax.xml.namespace.QName qname, IEnumerable content)
	{
		return new MFAttribute(qname, content);
	}

	public static IMFNode createAttribute(String name, IEnumerable content)
	{
		return new MFAttribute(name, content);
	}
	...
	{
		return node.select(IMFNode.MFQueryKind_AllChildren, null);
	}

	public static IEnumerable selectAttributes(IMFNode node)
	{
		return node.select(IMFNode.MFQueryKind_AllAttributes, null);
	}

	public static IEnumerable filterElements(javax.xml.namespace.QName qname, IMFNode node)
	{
		return node.select(IMFNode.MFQueryKind_ChildrenByQName, qname);
	}

	public static IEnumerable filterElements(String name, IMFNode node)
	{
		return node.select(IMFNode.MFQueryKind_ChildrenByNodeName, name);
	}

	public static IEnumerable filterAttributes(javax.xml.namespace.QName qname, IMFNode node)
	{
		return node.select(IMFNode.MFQueryKind_AttributeByQName, qname);
	}

	public static IEnumerable filterAttributes(String name, IMFNode node)
	{
		return node.select(IMFNode.MFQueryKind_AttributeByNodeName, name);
	}

	public static boolean nodeNameEqual(javax.xml.namespace.QName qname, IMFNode node)
	{
		return qname.getLocalPart().equals( node.getLocalName() ) && qname.getNamespaceURI().equals( node.getNamespaceURI() );
	}

	public static boolean nodeNameEqual(String nodename, IMFNode node)
	{
		return nodename.equals(node.getNodeName());
	}

	public static boolean attributeNameEqual(javax.xml.namespace.QName qname, IMFNode node)
	{
	...
	{
		if (!content.contains("?>"))
			return new MFProcessingInstruction(content, name);
		
		return new MFProcessingInstruction(content.replace("?>", "? >"), name);
	}
