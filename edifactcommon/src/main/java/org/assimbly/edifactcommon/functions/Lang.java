...
import org.assimbly.edifactcommon.types.NotANumberException;
...
public class Lang
{
	...
	public static BigDecimal millisecondFromDatetime(DateTime dt) { return castToBigDecimal( dt.getPartSecond() * 1000.0 ); }
	...
	public static BigDecimal millisecondFromDuration(Duration dur) { return castToBigDecimal( dur.getPartSecond() * 1000.0 ); }
