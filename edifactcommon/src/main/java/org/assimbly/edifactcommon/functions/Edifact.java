...
public class Edifact 
{
  ...
  private static DateTime toTime( String sValue, String sFormat, boolean bRaiseExc )
  {
	...
	switch( Integer.parseInt(sFormat) )
	{
		...
		default:
		{
			if ( bRaiseExc ) throw new AltovaException("Unknown format code. Cannot convert the value '" + sValue + "' using the format code '" + sFormat + "'." );
		}
  ...
  private static void checkLength( String sValue, String sFormat, int nLength ) 
  {
		  if ( sValue.length() != nLength)
			  throw new AltovaException ("Cannot convert the value '" + sValue + "' using the format code '" + sFormat + "'. Expected length '" + nLength + "'." );
  }
  ...
  private static void checkMinMaxLength( String sValue, String sFormat, int nMinLength, int nMaxLength ) 
  {
	  if ( ( sValue.length() < nMinLength ) || ( sValue.length() > nMaxLength ) )
		  throw new AltovaException ("Cannot convert the value '" + sValue + "' using the format code '" + sFormat + "'. Expected length between '" + nMinLength + "' and '" + nMaxLength + "'." );
  }
