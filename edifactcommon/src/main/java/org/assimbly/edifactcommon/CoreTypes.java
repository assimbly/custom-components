...
import org.assimbly.edifactcommon.mapforce.MFEmptySequence;
...
public class CoreTypes
{
	...
	public static String nodeToString(IMFNode node) throws Exception
	{
		return node.value();
	}
	
	public static javax.xml.namespace.QName nodeToQName(IMFNode node) throws Exception
	{
	...
	public static org.assimbly.edifactcommon.functions.Core.Group castToGroup(Object o)
	{
		return (org.assimbly.edifactcommon.functions.Core.Group) o;
	}
	...
	public static IMFNode castToIMFNode(Object o)
	{
		...
		final class ANode implements IMFNode
		{
			...
			public IEnumerable select(int mfQueryKind, Object query) { return new MFEmptySequence(); }
	...
	public static javax.xml.namespace.QName castToQName(IMFNode n) throws Exception
	{
		return n.qnameValue();
	}
