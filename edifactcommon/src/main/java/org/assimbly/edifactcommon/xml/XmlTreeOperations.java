...
import org.assimbly.edifactcommon.SourceInstanceUnavailableException;
import org.assimbly.edifactcommon.TargetInstanceUnavailableException;
...
public class XmlTreeOperations
{
    ...
    public static void saveDocument(Document doc, Output output, String encoding, boolean bBigEndian, boolean bBOM, boolean prettyPrint, boolean omitXmlDecl ) throws Exception
    {
