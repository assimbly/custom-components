...
public class Duration extends CalendarBase 
{
	...
	public String toYearMonthString()
	{
		...
		if (year != 0) 
		{
			s.append(new DecimalFormat("0", new DecimalFormatSymbols(java.util.Locale.US)).format( (long) Math.abs(year) ) );
			s.append("Y");
		}
		if (month != 0) 
		{
			s.append(new DecimalFormat("0", new DecimalFormatSymbols(java.util.Locale.US)).format( (long) Math.abs(month) ) );
			s.append("M");
		}
		if (s.length() == 1)
			s.append("0M");
	...
	public String toString() 
	{
		...
		if (day != 0) 
		{
			s.append(new DecimalFormat("0", new DecimalFormatSymbols(java.util.Locale.US)).format( (long) Math.abs(day) ) );
			s.append("D");
		}
		if (hour!=0 || minute!=0 || second!=0 || partsecond>0 )	
		{
			...
			if (hour != 0) 
			{
				s.append(new DecimalFormat("0", new DecimalFormatSymbols(java.util.Locale.US)).format( (long) Math.abs(hour)) );
				s.append("H");
			}
			if (minute != 0) 
			{
				s.append(new DecimalFormat("0", new DecimalFormatSymbols(java.util.Locale.US)).format( (long) Math.abs(minute) ) );
				s.append("M");
			}
			if (second != 0)
				s.append(new DecimalFormat("0", new DecimalFormatSymbols(java.util.Locale.US)).format( (long) Math.abs(second) ) );
