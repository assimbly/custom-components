...
public class MailRecipientsPipeIssueTest extends CamelTestSupport {
    ...
    public void testMultiRecipients() throws Exception {
        ...
        Assertions.assertEquals(you.getEmail(), msg.getFrom()[0].toString());
        Assertions.assertEquals(camelPipes.getEmail(), msg.getRecipients(Message.RecipientType.TO)[0].toString());
        Assertions.assertEquals(easyPipes.getEmail(), msg.getRecipients(Message.RecipientType.TO)[1].toString());
