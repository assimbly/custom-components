...
public class MailMoveToTest extends CamelTestSupport {
    ...
    public void testMoveToWithDelete() throws Exception {
        ...
        Assertions.assertFalse(jones2.getFolder("moveToFolder").get(0).getFlags().contains(Flags.Flag.SEEN));
        Assertions.assertFalse(jones2.getFolder("moveToFolder").get(1).getFlags().contains(Flags.Flag.SEEN));
        Assertions.assertFalse(jones2.getFolder("moveToFolder").get(2).getFlags().contains(Flags.Flag.SEEN));
        Assertions.assertFalse(jones2.getFolder("moveToFolder").get(3).getFlags().contains(Flags.Flag.SEEN));
        Assertions.assertFalse(jones2.getFolder("moveToFolder").get(4).getFlags().contains(Flags.Flag.SEEN));
    }
