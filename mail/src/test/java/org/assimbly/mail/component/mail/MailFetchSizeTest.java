...
public class MailFetchSizeTest extends CamelTestSupport {
    ...
    public void testFetchSize() throws Exception {
        Assertions.assertEquals(5, jones.getInbox().getMessageCount());
        ...
        Awaitility.await().atMost(500, TimeUnit.MILLISECONDS)
                .untilAsserted(() -> Assertions.assertEquals(3, jones.getInbox().getMessageCount()));
        ...
        Awaitility.await().atMost(500, TimeUnit.MILLISECONDS)
                .untilAsserted(() -> Assertions.assertEquals(1, jones.getInbox().getMessageCount()));
