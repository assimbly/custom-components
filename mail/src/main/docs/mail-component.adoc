...
`org.assimbly.mail.component.mail.SplitAttachmentsExpression`, which you
...
---------------------------------------------------------------------------------
<split>
  <method beanType="org.assimbly.mail.component.mail.SplitAttachmentsExpression"/>
  <to uri="mock:split"/>
</split>
---------------------------------------------------------------------------------
...
word "Camel". +
 The class `org.assimbly.mail.component.mail.SimpleSearchTerm` has a
...
`SearchTerms` using the `org.assimbly.mail.component.mail.SearchTermBuilder`
