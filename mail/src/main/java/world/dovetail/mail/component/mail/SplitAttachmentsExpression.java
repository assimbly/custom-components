...
public class SplitAttachmentsExpression extends ExpressionAdapter {
    ...
    public Object evaluate(Exchange exchange) {
         ...
         * https://dovetailworld.atlassian.net/browse/DOV-220
         */
     ...
     *
     * Dovetail Edit: Copied from org.apache.camel.component.mail.MailBinding (2.20.1)
     */
    ...
    /**
     * Dovetail Edit: Custom method to force unique filenames that will be stored in the Attachments Map as
