 ...
 */
package world.dovetail.mail.component.mail;
...
import static world.dovetail.mail.component.mail.MailConstants.MAIL_GENERATE_MISSING_ATTACHMENT_NAMES_NEVER;
import static world.dovetail.mail.component.mail.MailConstants.MAIL_HANDLE_DUPLICATE_ATTACHMENT_NAMES_NEVER;
...
public class MailConfiguration implements Cloneable {
    ...
    /**
     * To use a custom {@link world.dovetail.mail.component.mail.JavaMailSender} for sending emails.
     */
