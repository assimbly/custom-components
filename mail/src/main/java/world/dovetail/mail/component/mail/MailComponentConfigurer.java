...
public class MailComponentConfigurer extends PropertyConfigurerSupport implements GeneratedPropertyConfigurer, PropertyConfigurerGetter {
    ...
    private world.dovetail.mail.component.mail.MailConfiguration getOrCreateConfiguration(MailComponent target) {
        if (target.getConfiguration() == null) {
            target.setConfiguration(new world.dovetail.mail.component.mail.MailConfiguration());
        }
    ...
    public boolean configure(CamelContext camelContext, Object obj, String name, Object value, boolean ignoreCase) {
        ...
        switch (ignoreCase ? name.toLowerCase() : name) {
            ...
            case "attachmentsContentTransferEncodingResolver": getOrCreateConfiguration(target).setAttachmentsContentTransferEncodingResolver(property(camelContext, world.dovetail.mail.component.mail.AttachmentsContentTransferEncodingResolver.class, value)); return true;
            case "authenticator": getOrCreateConfiguration(target).setAuthenticator(property(camelContext, world.dovetail.mail.component.mail.MailAuthenticator.class, value)); return true;
            ...
            case "configuration": target.setConfiguration(property(camelContext, world.dovetail.mail.component.mail.MailConfiguration.class, value)); return true;
            ...
            case "javamailsender":
            case "javaMailSender": getOrCreateConfiguration(target).setJavaMailSender(property(camelContext, world.dovetail.mail.component.mail.JavaMailSender.class, value)); return true;
    ...
    public Class getOptionType(String name, boolean ignoreCase) {
        switch (ignoreCase ? name.toLowerCase() : name) {
            ...
            case "configuration": return world.dovetail.mail.component.mail.MailConfiguration.class;
            case "connectiontimeout":
    ...
    public Object getOptionValue(Object obj, String name, boolean ignoreCase) {
        ...
        switch (ignoreCase ? name.toLowerCase() : name) {
            ...
            case "tenant": return getOrCreateConfiguration(target).getTenant();
