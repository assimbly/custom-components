...
import static world.dovetail.googledrive.domain.GSuiteFilesTypeHelper.getConversionMimeType;
import static world.dovetail.googledrive.domain.GSuiteFilesTypeHelper.getGSuiteFileName;
import static world.dovetail.googledrive.domain.GSuiteFilesTypeHelper.isGSuiteFile;
...
public class GoogleDriveEndpoint extends ProcessorEndpoint {
    ...
    private static final String APPLICATION_NAME = "Dovetail";
