...
import world.dovetail.xmltojson.domain.TypeValueMismatch;
import world.dovetail.xmltojson.processor.JsonToXmlJsonProcessor;
import world.dovetail.xmltojson.processor.JsonToXmlXmlProcessor;
import world.dovetail.xmltojson.processor.XmlToJsonJsonProcessor;
import world.dovetail.xmltojson.processor.XmlToJsonXmlProcessor;
...
public class CustomXmlJsonDataFormat implements DataFormat {
    ...
    private final String xmlAttrPrefix = "DOVETAIL_ATTR_PREFIX";
    private final String jsonXmlAttrPrefix = "@";

    private final String xmlTypeNodePrefix = "DOVETAIL_TYPE_PREFIX";
