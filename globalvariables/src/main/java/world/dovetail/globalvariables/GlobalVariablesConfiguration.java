...
import world.dovetail.globalvariables.domain.Operation;


@UriParams
public class GlobalVariablesConfiguration implements Cloneable {
    ...
    public GlobalVariablesConfiguration() { }
