package world.dovetail.globalvariables;
...
import org.assimbly.util.exception.DovetailEnvironmentException;
...
import world.dovetail.globalvariables.domain.EnvironmentValue;
import world.dovetail.globalvariables.domain.GlobalEnvironmentVariable;
import world.dovetail.globalvariables.mongo.MongoDao;
import world.dovetail.globalvariables.mongo.MongoDaoImpl;
...
public class GlobalVariablesProcessor implements Processor {
    ...
    private static final String DOVETAIL_ENCRYPTION_SECRET = "DOVETAIL_ENCRYPTION_SECRET";

    private EncryptionUtil encryptionUtil = new EncryptionUtil(DOVETAIL_ENCRYPTION_SECRET, "PBEWithHMACSHA512AndAES_256");

    private final String TENANT_DEFAULT = "default";
    private static final String DOVETAIL_ENVIRONMENT = "DOVETAIL_ENV";
    ...
    private void getGlobalVariable(Exchange exchange) {
        ...
        String environment = (endpoint.getConfiguration().getEnvironment()!=null ? endpoint.getConfiguration().getEnvironment() : System.getenv(DOVETAIL_ENVIRONMENT));
    ...
    private String interpolateVar(String varValue, Exchange exchange, String expressionType) {
        ...
        try {
            ...
            throw new DovetailEnvironmentException("Error to interpolate variable.");
        }
    ...
    public static String getEnvironment() {
        return System.getProperty(DOVETAIL_ENVIRONMENT);
    }
}