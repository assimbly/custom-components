...
import org.assimbly.edifactstandards.transformer.*;
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        switch(config.getType()){
            ...
            case XML_TO_IFTFCC_D00B:
                org.assimbly.edifactstandards.xml.transformer.IFTFCCD00BTransformer iftfccd00BTransformerToXml = new org.assimbly.edifactstandards.xml.transformer.IFTFCCD00BTransformer();
                iftfccd00BTransformerToXml.run(input, output);
                break;
            case XML_TO_IFTMBF_D95B:
                org.assimbly.edifactstandards.xml.transformer.IFTMBFD95BTransformer iftmbfd95BTransformerToXml = new org.assimbly.edifactstandards.xml.transformer.IFTMBFD95BTransformer();
                iftmbfd95BTransformerToXml.run(input, output);
                break;
            case XML_TO_IFTMIN_D99B:
                org.assimbly.edifactstandards.xml.transformer.IFTMIND99BTransformer iftmind99BTransformerToXml = new org.assimbly.edifactstandards.xml.transformer.IFTMIND99BTransformer();
