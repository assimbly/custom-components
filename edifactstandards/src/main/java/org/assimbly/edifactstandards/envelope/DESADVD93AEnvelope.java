...
public class DESADVD93AEnvelope extends TextDocument
{
    // EDI Fields
    ...
    static void initFieldF0007 () {
        ...
        mFieldF0007 = new DataElement ("F0007",
                new DataTypeValidatorString(0, 4, new DataValueCodeListValidator(true, mCodeListF0007)
                )
        );
    }
    ...
    static void initFieldF0025 () {
        ...
        mFieldF0025 = new DataElement ("F0025",
                new DataTypeValidatorString(2, 2, new DataValueCodeListValidator(true, mCodeListF0025)
                )
        );
    }
    ...
    static void initFieldF0029 () {
        ...
        mFieldF0029 = new DataElement ("F0029",
                new DataTypeValidatorString(1, 1, new DataValueCodeListValidator(true, mCodeListF0029)
                )
        );
    }
    ...
    static void initFieldF0051 () {
        ...
        mFieldF0051 = new DataElement ("F0051",
                new DataTypeValidatorString(0, 3, new DataValueCodeListValidator(true, mCodeListF0051)
                )
        );
    }
    ...
    static void initFieldF0065 () {
        ...
        mFieldF0065 = new DataElement ("F0065",
                new DataTypeValidatorString(0, 6, new DataValueCodeListValidator(true, mCodeListF0065)
                )
        );
    }
    ...
    static void initFieldF0073 () {
        ...
        mFieldF0073 = new DataElement ("F0073",
                new DataTypeValidatorString(1, 1, new DataValueCodeListValidator(true, mCodeListF0073)
                )
        );
    }
    ...
    static void initFieldF1001 () {
        ...
        mFieldF1001 = new DataElement ("F1001",
                new DataTypeValidatorString(0, 3, new DataValueCodeListValidator(false, mCodeListF1001)
                )
        );
    }
    ...
    static void initFieldF1082 () {
        mFieldF1082 = new DataElement ("F1082",
                new DataTypeValidatorDecimal(0, 6, 0)
        );
    }
    ...
    static void initFieldF1222 () {
        mFieldF1222 = new DataElement ("F1222",
                new DataTypeValidatorDecimal(0, 2, 0)
        );
    }
    ...
    static StructureItem getFieldF1229() { if (mFieldF1229 == null) { initFieldF1229(); } return mFieldF1229; }
    static void initFieldF1229 () {
        initCodeListF1229();
        mFieldF1229 = new DataElement ("F1229",
    ...
    static void initFieldF3239 () {
        mFieldF3239 = new DataElement ("F3239",
                new DataTypeValidatorString(0, 3, null
                )
        );
    }
    ...
    static StructureItem getFieldF4183() { if (mFieldF4183 == null) { initFieldF4183(); } return mFieldF4183; }
    static void initFieldF4183 () {
        initCodeListF4183();
        mFieldF4183 = new DataElement ("F4183",
    ...
    static StructureItem getFieldF4221() { if (mFieldF4221 == null) { initFieldF4221(); } return mFieldF4221; }
    static void initFieldF4221 () {
        initCodeListF4221();
        mFieldF4221 = new DataElement ("F4221",
    ...
    static void initFieldF4294 () {
        mFieldF4294 = new DataElement ("F4294",
                new DataTypeValidatorString(0, 35, null
                )
        );
    }
    ...
    static StructureItem getFieldF4295() { if (mFieldF4295 == null) { initFieldF4295(); } return mFieldF4295; }
    static void initFieldF4295 () {
        initCodeListF4295();
        mFieldF4295 = new DataElement ("F4295",
    ...
    static void initFieldF4400 () {
        mFieldF4400 = new DataElement ("F4400",
                new DataTypeValidatorString(0, 35, null
                )
        );
    }
    ...
    static void initCodeListF4401 () {
        mCodeListF4401 = new String[] { "AA","AB","AD","AE","AF","AG","AH","AP","AT","DA","DB","DC","DD","DE","DF","DG","DH","DI","DJ","DK","DN","DO","DP","EI","EM","EX","QC","QE","RL","SW" };
    }
    static StructureItem mFieldF4401 = null;
    static StructureItem getFieldF4401() { if (mFieldF4401 == null) { initFieldF4401(); } return mFieldF4401; }
    static void initFieldF4401 () {
        initCodeListF4401();
        mFieldF4401 = new DataElement ("F4401",
    ...
    static StructureItem getFieldF4403() { if (mFieldF4403 == null) { initFieldF4403(); } return mFieldF4403; }
    static void initFieldF4403 () {
        initCodeListF4403();
        mFieldF4403 = new DataElement ("F4403",
    ...
    static StructureItem getFieldF4455() { if (mFieldF4455 == null) { initFieldF4455(); } return mFieldF4455; }
    static void initFieldF4455 () {
        initCodeListF4455();
        mFieldF4455 = new DataElement ("F4455",
                new DataTypeValidatorString(0, 3, new DataValueCodeListValidator(true, mCodeListF4455)
                )
        );
    }
    ...
    static StructureItem getFieldF4457() { if (mFieldF4457 == null) { initFieldF4457(); } return mFieldF4457; }
    static void initFieldF4457 () {
        initCodeListF4457();
        mFieldF4457 = new DataElement ("F4457",
                new DataTypeValidatorString(0, 3, new DataValueCodeListValidator(true, mCodeListF4457)
                )
        );
    }
    ...
    static StructureItem getFieldF5495() { if (mFieldF5495 == null) { initFieldF5495(); } return mFieldF5495; }
    static void initFieldF5495 () {
        initCodeListF5495();
        mFieldF5495 = new DataElement ("F5495",
    ...
    static void initFieldF6064 () {
        mFieldF6064 = new DataElement ("F6064",
                new DataTypeValidatorDecimal(0, 15, 0)
        );
    }
    ...
    static void initFieldF7008 () {
        mFieldF7008 = new DataElement ("F7008",
                new DataTypeValidatorString(0, 35, null
                )
        );
    }
    ...
    static void initFieldF7009 () {
        mFieldF7009 = new DataElement ("F7009",
    ...
    static StructureItem getFieldF7073() { if (mFieldF7073 == null) { initFieldF7073(); } return mFieldF7073; }
    static void initFieldF7073 () {
        initCodeListF7073();
        mFieldF7073 = new DataElement ("F7073",
    ...
    static StructureItem getFieldF7075() { if (mFieldF7075 == null) { initFieldF7075(); } return mFieldF7075; }
    static void initFieldF7075 () {
        initCodeListF7075();
        mFieldF7075 = new DataElement ("F7075",
    ...
    static StructureItem getFieldF7077() { if (mFieldF7077 == null) { initFieldF7077(); } return mFieldF7077; }
    static void initFieldF7077 () {
        initCodeListF7077();
        mFieldF7077 = new DataElement ("F7077",
    ...
    static StructureItem getFieldF7081() { if (mFieldF7081 == null) { initFieldF7081(); } return mFieldF7081; }
    static void initFieldF7081 () {
        initCodeListF7081();
        mFieldF7081 = new DataElement ("F7081",
    ...
    static StructureItem getFieldF7083() { if (mFieldF7083 == null) { initFieldF7083(); } return mFieldF7083; }
    static void initFieldF7083 () {
        initCodeListF7083();
        mFieldF7083 = new DataElement ("F7083",
    ...
    static void initFieldF7160 () {
        mFieldF7160 = new DataElement ("F7160",
                new DataTypeValidatorString(0, 35, null
                )
        );
    }
    ...
    static StructureItem getFieldF7161() { if (mFieldF7161 == null) { initFieldF7161(); } return mFieldF7161; }
    static void initFieldF7161 () {
        initCodeListF7161();
        mFieldF7161 = new DataElement ("F7161",
    ...
    static StructureItem getFieldF7164() { if (mFieldF7164 == null) { initFieldF7164(); } return mFieldF7164; }
    static void initFieldF7164 () {
        mFieldF7164 = new DataElement ("F7164",
    ...
    static StructureItem getFieldF7166() { if (mFieldF7166 == null) { initFieldF7166(); } return mFieldF7166; }
    static void initFieldF7166 () {
        mFieldF7166 = new DataElement ("F7166",
                new DataTypeValidatorString(0, 12, null
                )
        );
    }
    ...
    static StructureItem getFieldF7297() { if (mFieldF7297 == null) { initFieldF7297(); } return mFieldF7297; }
    static void initFieldF7297 () {
        initCodeListF7297();
        mFieldF7297 = new DataElement ("F7297",
    ...
    static void initFieldF8155 () {
        ...
        mFieldF8155 = new DataElement ("F8155",
                new DataTypeValidatorString(0, 4, new DataValueCodeListValidator(true, mCodeListF8155)
                )
        );
    }
    ...
    static StructureItem getFieldF8275() { if (mFieldF8275 == null) { initFieldF8275(); } return mFieldF8275; }
    ...
    static StructureItem getFieldF8325() { if (mFieldF8325 == null) { initFieldF8325(); } return mFieldF8325; }
    ...
    static StructureItem getFieldF8393() { if (mFieldF8393 == null) { initFieldF8393(); } return mFieldF8393; }
    static void initFieldF8393 () {
        initCodeListF8393();
        mFieldF8393 = new DataElement ("F8393",
    ...
    static StructureItem getFieldF8395() { if (mFieldF8395 == null) { initFieldF8395(); } return mFieldF8395; }
    static void initFieldF8395 () {
        initCodeListF8395();
        mFieldF8395 = new DataElement ("F8395",
    ...
    static StructureItem getFieldF9213() { if (mFieldF9213 == null) { initFieldF9213(); } return mFieldF9213; }
    static void initFieldF9213 () {
        initCodeListF9213();
        mFieldF9213 = new DataElement ("F9213",
    ...
    static StructureItem getFieldF9303() { if (mFieldF9303 == null) { initFieldF9303(); } return mFieldF9303; }
    ...
    static void initFieldC040 () {
        mFieldC040 = new Composite ("C040",
                new Particle[]{
                        ...
                        new Particle("F1131", getFieldF1131(), 0, 1, 1, false, new String[]{}),
                        new Particle("F3055", getFieldF3055(), 0, 1, 1, false, new String[]{}),
                        new Particle("F3128", getFieldF3128(), 0, 1, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initFieldC059 () {
        mFieldC059 = new Composite ("C059",
                new Particle[]{
                        new Particle("F3042", getFieldF3042(), 1, 1, 3, false, new String[]{}),
                }
        );
    }
    ...
    static void initFieldC214 () {
        mFieldC214 = new Composite ("C214",
                new Particle[]{
                        new Particle("F7161", getFieldF7161(), 1, 1, 1, false, new String[]{}),
                        new Particle("F1131", getFieldF1131(), 0, 1, 1, false, new String[]{}),
                        new Particle("F3055", getFieldF3055(), 0, 1, 1, false, new String[]{}),
                        new Particle("F7160", getFieldF7160(), 0, 1, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initFieldC215 () {
        mFieldC215 = new Composite ("C215",
                new Particle[]{
                        new Particle("F9303", getFieldF9303(), 0, 1, 1, false, new String[]{}),
                        new Particle("F1131", getFieldF1131(), 0, 1, 1, false, new String[]{}),
                        new Particle("F3055", getFieldF3055(), 0, 1, 1, false, new String[]{}),
                        new Particle("F9302", getFieldF9302(), 0, 1, 1, false, new String[]{}),
                }
        );
    }
    ...
    static StructureItem getFieldC262() { if (mFieldC262 == null) { initFieldC262(); } return mFieldC262; }
    static void initFieldC262 () {
        mFieldC262 = new Composite ("C262",
                new Particle[]{
                        new Particle("F4295", getFieldF4295(), 0, 1, 1, false, new String[]{}),
                        new Particle("F4294", getFieldF4294(), 0, 1, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initFieldC273 () {
        mFieldC273 = new Composite ("C273",
                new Particle[]{
                        new Particle("F7009", getFieldF7009(), 0, 1, 1, false, new String[]{}),
                        new Particle("F1131", getFieldF1131(), 0, 1, 1, false, new String[]{}),
                        new Particle("F3055", getFieldF3055(), 0, 1, 1, false, new String[]{}),
                        new Particle("F7008", getFieldF7008(), 0, 1, 2, false, new String[]{}),
                }
        );
    }
    ...
    static void initFieldC279 () {
        mFieldC279 = new Composite ("C279",
                new Particle[]{
                        new Particle("F6064", getFieldF6064(), 1, 1, 1, false, new String[]{}),
                        new Particle("F6063", getFieldF6063(), 0, 1, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initFieldC402 () {
        mFieldC402 = new Composite ("C402",
                new Particle[]{
                        new Particle("F7077", getFieldF7077(), 1, 1, 1, false, new String[]{}),
                        new Particle("F7064_1", getFieldF7064(), 1, 1, 1, false, new String[]{}),
                        new Particle("F7143_1", getFieldF7143(), 0, 1, 1, false, new String[]{}),
                        new Particle("F7064_2", getFieldF7064(), 0, 1, 1, false, new String[]{}),
                        new Particle("F7143_2", getFieldF7143(), 0, 1, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initFieldC522 () {
        mFieldC522 = new Composite ("C522",
                new Particle[]{
                        new Particle("F4403", getFieldF4403(), 1, 1, 1, false, new String[]{}),
                        new Particle("F4401", getFieldF4401(), 0, 1, 1, false, new String[]{}),
                        new Particle("F1131", getFieldF1131(), 0, 1, 1, false, new String[]{}),
                        new Particle("F3055", getFieldF3055(), 0, 1, 1, false, new String[]{}),
                        new Particle("F4400", getFieldF4400(), 0, 1, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initFieldC531 () {
        mFieldC531 = new Composite ("C531",
                new Particle[]{
                        new Particle("F7075", getFieldF7075(), 0, 1, 1, false, new String[]{}),
                        new Particle("F7233", getFieldF7233(), 0, 1, 1, false, new String[]{}),
                        new Particle("F7073", getFieldF7073(), 0, 1, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initFieldC532 () {
        mFieldC532 = new Composite ("C532",
                new Particle[]{
                        new Particle("F8395", getFieldF8395(), 0, 1, 1, false, new String[]{}),
                        new Particle("F8393", getFieldF8393(), 0, 1, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initStructureALI () {
        mStructureALI = new Segment ("ALI","", "",
                new Particle[]{
                        new Particle("F3239", getFieldF3239(), 0, 1, 1, false, new String[]{}),
                        new Particle("F9213", getFieldF9213(), 0, 1, 1, false, new String[]{}),
                        new Particle("F4183", getFieldF4183(), 0, 1, 5, false, new String[]{}),
                }
        );
    }
    ...
    static StructureItem getStructureCPS() { if (mStructureCPS == null) { initStructureCPS(); } return mStructureCPS; }
    static void initStructureCPS () {
        mStructureCPS = new Segment ("CPS","", "",
                new Particle[]{
                        new Particle("F7164", getFieldF7164(), 1, 1, 1, false, new String[]{}),
                        new Particle("F7166", getFieldF7166(), 0, 1, 1, false, new String[]{}),
                        new Particle("F7075", getFieldF7075(), 0, 1, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initStructureDGS () {
        mStructureDGS = new Segment ("DGS","", "",
                new Particle[]{
                        ...
                        new Particle("F8325", getFieldF8325(), 0, 1, 1, false, new String[]{}),
    ...
    static StructureItem getStructureDLM() { if (mStructureDLM == null) { initStructureDLM(); } return mStructureDLM; }
    static void initStructureDLM () {
        mStructureDLM = new Segment ("DLM","", "",
                new Particle[]{
                        new Particle("F4455", getFieldF4455(), 0, 1, 1, false, new String[]{}),
                        new Particle("C522", getFieldC522(), 0, 1, 1, false, new String[]{}),
                        new Particle("C214", getFieldC214(), 0, 1, 1, false, new String[]{}),
                        new Particle("F4457", getFieldF4457(), 0, 1, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initStructureGIR () {
        mStructureGIR = new Segment ("GIR","", "",
                new Particle[]{
                        new Particle("F7297", getFieldF7297(), 1, 1, 1, false, new String[]{}),
                        new Particle("C206", getFieldC206(), 1, 1, 5, false, new String[]{}),
                }
        );
    }
    ...
    static void initStructureIMD () {
        mStructureIMD = new Segment ("IMD","", "",
                new Particle[]{
                        new Particle("F7077", getFieldF7077(), 0, 1, 1, false, new String[]{}),
                        new Particle("F7081", getFieldF7081(), 0, 1, 1, false, new String[]{}),
                        new Particle("C273", getFieldC273(), 0, 1, 1, false, new String[]{}),
    ...
    static void initStructureLIN () {
        mStructureLIN = new Segment ("LIN","", "",
                new Particle[]{
                        new Particle("F1082", getFieldF1082(), 0, 1, 1, false, new String[]{}),
                        new Particle("F1229", getFieldF1229(), 0, 1, 1, false, new String[]{}),
                        new Particle("C212", getFieldC212(), 0, 1, 1, false, new String[]{}),
                        new Particle("F5495", getFieldF5495(), 0, 1, 1, false, new String[]{}),
                        new Particle("F1222", getFieldF1222(), 0, 1, 1, false, new String[]{}),
                        new Particle("F7083", getFieldF7083(), 0, 1, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initStructurePAC () {
        mStructurePAC = new Segment ("PAC","", "",
                new Particle[]{
                        ...
                        new Particle("C531", getFieldC531(), 0, 1, 1, false, new String[]{}),
                        new Particle("C202", getFieldC202(), 0, 1, 1, false, new String[]{}),
                        new Particle("C402", getFieldC402(), 0, 1, 1, false, new String[]{}),
                        new Particle("C532", getFieldC532(), 0, 1, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initStructurePCI () {
        mStructurePCI = new Segment ("PCI","", "",
                new Particle[]{
                        ...
                        new Particle("F8275", getFieldF8275(), 0, 1, 1, false, new String[]{}),
                }
        );
    }
    ...
    static StructureItem getStructureQVA() { if (mStructureQVA == null) { initStructureQVA(); } return mStructureQVA; }
    static void initStructureQVA () {
        mStructureQVA = new Segment ("QVA","", "",
                new Particle[]{
                        new Particle("C279", getFieldC279(), 0, 1, 1, false, new String[]{}),
                        new Particle("F4221", getFieldF4221(), 0, 1, 1, false, new String[]{}),
                        new Particle("C262", getFieldC262(), 0, 1, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initStructureSEL () {
        mStructureSEL = new Segment ("SEL","", "",
                new Particle[]{
                        new Particle("F9308", getFieldF9308(), 1, 1, 1, false, new String[]{}),
                        new Particle("C215", getFieldC215(), 0, 1, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initStructureTDT () {
        mStructureTDT = new Segment ("TDT","", "",
                new Particle[]{
                        ...
                        new Particle("C228", getFieldC228(), 0, 1, 1, false, new String[]{}),
    ...
    static StructureItem getStructureMessage_DESADV() { if (mStructureMessage_DESADV == null) { initStructureMessage_DESADV(); } return mStructureMessage_DESADV; }
    static void initStructureMessage_DESADV () {
        mStructureMessage_DESADV = new Group ("Message_DESADV","", "",
                new Particle[]{
                        new Particle("UNH", getStructureUNH(), 1, 1, 1, false, new String[]{}),
                        new Particle("BGM", getStructureBGM(), 1, 1, 1, false, new String[]{}),
                        new Particle("DTM", getStructureDTM(), 0, 10, 1, false, new String[]{}),
                        new Particle("ALI", getStructureALI(), 0, 5, 1, false, new String[]{}),
                        new Particle("MEA", getStructureMEA(), 0, 5, 1, false, new String[]{}),
                        new Particle("SG1", getStructureSG1(), 0, 10, 1, false, new String[]{}),
                        new Particle("SG2", getStructureSG2(), 0, 10, 1, false, new String[]{}),
                        new Particle("SG5", getStructureSG5(), 0, 10, 1, false, new String[]{}),
                        new Particle("SG6", getStructureSG6(), 0, 10, 1, false, new String[]{}),
                        new Particle("SG8", getStructureSG8(), 0, 10, 1, false, new String[]{}),
                        new Particle("SG10", getStructureSG10(), 0, 9999, 1, false, new String[]{}),
                        new Particle("CNT", getStructureCNT(), 0, 1, 1, false, new String[]{}),
    ...
    static void initStructureSG10 () {
        mStructureSG10 = new Group ("SG10","", "",
                new Particle[]{
                        new Particle("CPS", getStructureCPS(), 1, 1, 1, false, new String[]{}),
                        new Particle("FTX", getStructureFTX(), 0, 5, 1, false, new String[]{}),
                        new Particle("SG11", getStructureSG11(), 0, 9999, 1, false, new String[]{}),
                        new Particle("SG15", getStructureSG15(), 0, 9999, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initStructureSG11 () {
        mStructureSG11 = new Group ("SG11","", "",
                new Particle[]{
                        ...
                        new Particle("QTY", getStructureQTY(), 0, 10, 1, false, new String[]{}),
                        new Particle("SG12", getStructureSG12(), 0, 10, 1, false, new String[]{}),
                        new Particle("SG13", getStructureSG13(), 0, 1000, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initStructureSG12 () {
        mStructureSG12 = new Group ("SG12","", "",
                new Particle[]{
                        new Particle("HAN", getStructureHAN(), 1, 1, 1, false, new String[]{}),
                        new Particle("FTX", getStructureFTX(), 0, 10, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initStructureSG13 () {
        mStructureSG13 = new Group ("SG13","", "",
                new Particle[]{
                        ...
                        new Particle("SG14", getStructureSG14(), 0, 10, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initStructureSG14 () {
        mStructureSG14 = new Group ("SG14","", "",
                new Particle[]{
                        new Particle("GIN", getStructureGIN(), 1, 1, 1, false, new String[]{}),
                        new Particle("DLM", getStructureDLM(), 0, 10, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initStructureSG15 () {
        mStructureSG15 = new Group ("SG15","", "",
                new Particle[]{
                        ...
                        new Particle("PIA", getStructurePIA(), 0, 10, 1, false, new String[]{}),
                        new Particle("IMD", getStructureIMD(), 0, 25, 1, false, new String[]{}),
                        new Particle("MEA", getStructureMEA(), 0, 10, 1, false, new String[]{}),
                        new Particle("QTY", getStructureQTY(), 0, 10, 1, false, new String[]{}),
                        new Particle("ALI", getStructureALI(), 0, 10, 1, false, new String[]{}),
                        new Particle("GIN", getStructureGIN(), 0, 100, 1, false, new String[]{}),
                        new Particle("GIR", getStructureGIR(), 0, 100, 1, false, new String[]{}),
                        new Particle("DLM", getStructureDLM(), 0, 100, 1, false, new String[]{}),
                        new Particle("DTM", getStructureDTM(), 0, 5, 1, false, new String[]{}),
                        new Particle("FTX", getStructureFTX(), 0, 5, 1, false, new String[]{}),
                        new Particle("SG16", getStructureSG16(), 0, 10, 1, false, new String[]{}),
                        new Particle("SG17", getStructureSG17(), 0, 10, 1, false, new String[]{}),
                        new Particle("SG18", getStructureSG18(), 0, 100, 1, false, new String[]{}),
                        new Particle("SG19", getStructureSG19(), 0, 1000, 1, false, new String[]{}),
                        new Particle("SG20", getStructureSG20(), 0, 9999, 1, false, new String[]{}),
                        new Particle("SG23", getStructureSG23(), 0, 10, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initStructureSG17 () {
        mStructureSG17 = new Group ("SG17","", "",
                new Particle[]{
                        ...
                        new Particle("QTY", getStructureQTY(), 0, 1, 1, false, new String[]{}),
                        new Particle("FTX", getStructureFTX(), 0, 5, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initStructureSG18 () {
        mStructureSG18 = new Group ("SG18","", "",
                new Particle[]{
                        ...
                        new Particle("NAD", getStructureNAD(), 0, 1, 1, false, new String[]{}),
                        new Particle("DTM", getStructureDTM(), 0, 1, 1, false, new String[]{}),
                        new Particle("QTY", getStructureQTY(), 0, 10, 1, false, new String[]{}),
                }
        );
    ...
    static void initStructureSG2 () {
        mStructureSG2 = new Group ("SG2","", "",
                new Particle[]{
                        ...
                        new Particle("SG3", getStructureSG3(), 0, 10, 1, false, new String[]{}),
                        new Particle("SG4", getStructureSG4(), 0, 10, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initStructureSG20 () {
        mStructureSG20 = new Group ("SG20","", "",
                new Particle[]{
                        ...
                        new Particle("MEA", getStructureMEA(), 0, 10, 1, false, new String[]{}),
                        new Particle("QTY", getStructureQTY(), 0, 1, 1, false, new String[]{}),
                        new Particle("SG21", getStructureSG21(), 0, 10, 1, false, new String[]{}),
                        new Particle("SG22", getStructureSG22(), 0, 10, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initStructureSG23 () {
        mStructureSG23 = new Group ("SG23","", "",
                new Particle[]{
                        new Particle("QVA", getStructureQVA(), 1, 1, 1, false, new String[]{}),
                        new Particle("DTM", getStructureDTM(), 0, 5, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initStructureSG6 () {
        mStructureSG6 = new Group ("SG6","", "",
                new Particle[]{
                        ...
                        new Particle("SG7", getStructureSG7(), 0, 10, 1, false, new String[]{}),
                }
        );
    }
    ...
    static void initStructureSG8 () {
        mStructureSG8 = new Group ("SG8","", "",
                new Particle[]{
                        ...
                        new Particle("MEA", getStructureMEA(), 0, 5, 1, false, new String[]{}),
                        new Particle("SEL", getStructureSEL(), 0, 25, 1, false, new String[]{}),
                        new Particle("EQA", getStructureEQA(), 0, 5, 1, false, new String[]{}),
                        new Particle("SG9", getStructureSG9(), 0, 10, 1, false, new String[]{}),
                }
        );
    }
    ...
    {
        String[] arStandardSegments = new String[] { "AGR","AJT","ALC","ALI","API","APR","ARD","ATT","AUT","BGM","BII","BUS","CCI","CNI","CNT","COM","COT","CPI","CPS","CST","CTA","CUX","DGS","DIM","DLI","DLM","DMS","DOC","DTM","EMP","EQA","EQD","EQN","ERC","ERP","FCA","FII","FTX","GDS","GID","GIN","GIR","GIS","GOR","HAN","IMD","IND","INP","LIN","LOC","MEA","MEM","MOA","NAD","PAC","PAI","PAT","PCD","PCI","PGI","PIA","PIT","PRC","PRI","PSD","QTY","QVA","QVR","RCS","REL","RFF","RNG","RTE","SCC","SEL","SEQ","SGP","SPS","STA","STS","TAX","TCC","TDT","TEM","TMD","TMP","TOD","TPL","TSR","UCD","UCF","UCI","UCM","UCS","UGH","UGT","UIB","UIH","UIR","UIT","UIZ","UNA","UNB","UNE","UNG","UNH","UNO","UNP","UNS","UNT","UNZ","USA","USB","USC","USD","USE","USF","USH","USL","USR","UST","USU","USX","USY" };
        StandardSegments.addAll( java.util.Arrays.asList( arStandardSegments) );

        String[] arDESADVSegments = new String[] { "ALI","BGM","CNT","COM","CPS","CTA","DGS","DLM","DTM","EQA","EQD","FTX","GIN","GIR","HAN","IMD","LIN","LOC","MEA","NAD","PAC","PCD","PCI","PIA","QTY","QVA","RFF","SEL","SGP","TDT","TOD","UNH","UNT" };
        mMessages.put( "DESADV", new Message( "DESADV", new Particle("Message_DESADV", getStructureMessage_DESADV(), 1,1,1, false, new String[]{}), new java.util.HashSet<String>( java.util.Arrays.asList( arDESADVSegments) ), 0, 0, 0 ) );
    }

    public DESADVD93AEnvelope()
    {
        super(rootParticle);
        initSettings();
        initSegmentVectors();
    ...
    protected void initSettings()
    {
        ...
        // general settings:
        super.mSettings.setMessageType("DESADV");
        ...
        super.mSettings.setRelease("93A");
